 ...
 */
export function useCurrencyFromMap(currencyId?: string | null): Currency | null | undefined {
  ...
  const token = useTokenFromNetwork(isNative ? undefined : shorthandMatchAddress ?? currencyId)
